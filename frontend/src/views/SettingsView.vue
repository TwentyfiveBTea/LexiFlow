      ...
      <article class="settings-card account-card surface fade-in wide">
        ...
        <div class="account-profile">
          ...
          <div class="profile-username">
            ...
            <p class="inline-message" aria-live="polite">{{ usernameMessage || '\u00a0' }}</p>
          </div>
        </div>
...
.account-profile { display: grid; grid-template-columns: minmax(210px, .55fr) minmax(0, 1fr); align-items: center; gap: 24px; padding-bottom: 20px; margin-bottom: 20px; border-bottom: 1px solid rgba(199,196,192,.55); }.avatar-summary { min-width: 0; display: flex; align-items: center; gap: 16px; }.avatar-summary > div { min-width: 0; display: grid; align-items: start; gap: 5px; }.avatar-summary strong { overflow: hidden; display: block; color: var(--primary); font-size: 18px; text-overflow: ellipsis; white-space: nowrap; }.profile-username { min-width: 0; }.profile-avatar { position: relative; width: 70px; height: 70px; flex: 0 0 auto; display: grid; place-items: center; padding: 0; border: 1px solid var(--outline); border-radius: 50%; color: var(--secondary); background: var(--surface-high); }.profile-avatar img, .avatar-preview img { width: 100%; height: 100%; display: block; border-radius: inherit; object-fit: cover; }.profile-avatar > span { position: absolute; right: -2px; bottom: 1px; width: 25px; height: 25px; display: grid; place-items: center; border: 2px solid white; border-radius: 50%; color: white; background: var(--primary); }.avatar-action { margin: 0; }
.account-fields { display: grid; gap: 17px; }.readonly-field { width: 100%; height: 44px; display: flex; align-items: center; overflow: hidden; padding: 0 13px; border: 1px solid var(--outline); border-radius: 7px; color: var(--ink-muted); background: var(--surface-container); font-size: 13px; text-overflow: ellipsis; white-space: nowrap; }.username-control { display: grid; grid-template-columns: minmax(0, 1fr) auto; gap: 10px; }.username-control .field { font-size: 13px; }.username-control .btn:disabled { opacity: .5; cursor: not-allowed; }.inline-message { min-height: 16px; margin: 7px 0 0; color: var(--success); font-size: 11px; }

                  ...
                  <Transition name="library-picker">
                    <div v-if="libraryPickerFor === vocab.articleVocabId" class="library-picker surface">
                      ...
                      <template v-if="!compatibleLibraries.length">
                        ...
                        <button class="create-library-trigger" type="button" aria-haspopup="dialog" @click.stop.prevent="openCreateLibrary"><Plus :size="15" />新建{{ articleLanguageLabel }}词汇库</button>
                      </template>
                    </div>
                  </Transition>
                </div>

...
.library-picker-divider { height: 1px; margin: 8px 0; background: var(--outline); }.library-picker .create-library-trigger { min-height: 34px; justify-content: center; border: 1px solid var(--outline); border-radius: 6px; color: var(--primary); font-size: 13px; font-weight: 650; }.library-picker .create-library-trigger:hover { border-color: var(--primary); background: var(--primary-soft); }
.reader-create-backdrop { position: fixed; z-index: 70; inset: 0; display: grid; place-items: center; padding: 22px; background: rgba(27,28,28,.3); }.reader-create-modal { width: min(100%, 480px); padding: 30px; }.reader-create-modal .modal-heading { margin-bottom: 23px; }.reader-create-modal > .field-label { display: block; margin-top: 16px; }.reader-create-modal .field { width: 100%; background: white; font-size: 13px; }.fixed-language { height: 46px; display: flex; align-items: center; justify-content: center; gap: 8px; padding: 3px; border: 1px solid var(--outline); border-radius: 7px; color: var(--primary); background: var(--surface-low); }.fixed-language strong { font-size: 13px; text-transform: lowercase; }.fixed-language span { font-size: 11px; }.reader-create-modal .description-label { display: flex; align-items: center; justify-content: space-between; margin-top: 16px; }.reader-create-modal .description-label .field-label { margin: 0 0 7px; }.reader-create-modal .description-label span { color: var(--ink-muted); font-size: 10px; }.reader-create-modal .description-field { min-height: 96px; padding-block: 11px; resize: vertical; line-height: 1.55; }.reader-create-modal .form-message { margin: 14px 0 0; color: var(--error); font-size: 12px; }.reader-create-modal .modal-actions { display: flex; justify-content: flex-end; gap: 10px; margin-top: 22px; }

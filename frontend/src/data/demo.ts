...
export const collections: VocabularyCollection[] = [
  { id: 'core', name: '考研核心词汇', words: 1280, mastered: 1075, lastOpened: '今天', tone: 'blue' },
  { id: 'economist', name: '经济学人高频词', words: 450, mastered: 202, lastOpened: '昨天', tone: 'clay' },
  { id: 'academic', name: '学术写作必备', words: 320, mastered: 38, lastOpened: '2 小时前', tone: 'charcoal' },
  { id: 'literature', name: '现代文学鉴赏', words: 615, mastered: 566, lastOpened: '11 月 28 日', tone: 'sage' },
]
